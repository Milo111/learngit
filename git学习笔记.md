...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/michaelliao/learngit/search" class="js-site-search-form" data-scoped-search-url="/michaelliao/learngit/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
...
--><strong itemprop="name"><a href="/michaelliao/learngit" data-pjax="#js-repo-pjax-container">learngit</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax"
  ...
  <a href="/michaelliao/learngit/pulse" class="js-selected-navigation-item reponav-item" data-selected-links="pulse /michaelliao/learngit/pulse">
...
<!-- blob contrib key: blob_contributors:v21:2a314af46f2ea176ff773c1e71ebaa57 -->
...
<p>说明：在Git中，<code>HEAD</code>表示当前版本，<code>HEAD^</code>表示上一版本 <code>HEAD^^</code>表示上上一个版本</p>
